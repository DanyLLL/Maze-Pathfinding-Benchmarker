...
- **Algorithm Benchmarking** : Learned how to use `time import` to track, calculate, and display the exact execution speed of each pathfinding method to compare their efficiency.
